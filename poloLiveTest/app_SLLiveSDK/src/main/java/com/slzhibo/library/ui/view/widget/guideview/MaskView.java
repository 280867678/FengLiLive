...
public class MaskView extends ViewGroup {
    ...
    public MaskView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mOverlayRect.set(0.0f, 0.0f, (float) i2, (float) i3);
        ...
        this.mEraser.setFlags(Paint.ANTI_ALIAS_FLAG);
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.mOverlayRect.set(0.0f, 0.0f, (float) size, (float) size2);
        resetOutPath();
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (!(childAt == null || (layoutParams = (LayoutParams) childAt.getLayoutParams()) == null)) {
                ...
                if (i6 == 1) {
                    ...
                    rectF.left = rectF.right - ((float) childAt.getMeasuredWidth());
                    ...
                    rectF2.top = rectF2.bottom - ((float) childAt.getMeasuredHeight());
                    ...
                    rectF3.right = rectF3.left + ((float) childAt.getMeasuredWidth());
                    verticalChildPositionLayout(childAt, this.mChildTmpRect, layoutParams.targetParentPosition);
                } else if (i6 == 4) {
                ...
                this.mChildTmpRect.offset((float) ((int) ((((float) layoutParams.offsetX) * f) + 0.5f)), (float) ((int) ((((float) layoutParams.offsetY) * f) + 0.5f)));
    ...
    private void verticalChildPositionLayout(View view, RectF rectF, int i) {
        if (i == 16) {
            ...
            rectF.top = rectF2.bottom - ((float) view.getMeasuredHeight());
        }
    }
    ...
    private void resetPadding() {
        if (!this.ignoreRepadding) {
            ...
            if (i != 0 && this.mPaddingLeft == 0) {
                this.mTargetRect.left -= (float) i;
            }
            int i2 = this.mPadding;
            if (i2 != 0 && this.mPaddingTop == 0) {
                this.mTargetRect.top -= (float) i2;
            }
            int i3 = this.mPadding;
            if (i3 != 0 && this.mPaddingRight == 0) {
                this.mTargetRect.right += (float) i3;
            }
            int i4 = this.mPadding;
            if (i4 != 0 && this.mPaddingBottom == 0) {
                this.mTargetRect.bottom += (float) i4;
            }
            int i5 = this.mPaddingLeft;
            if (i5 != 0) {
                this.mTargetRect.left -= (float) i5;
            }
            int i6 = this.mPaddingTop;
            if (i6 != 0) {
                this.mTargetRect.top -= (float) i6;
            }
            int i7 = this.mPaddingRight;
            if (i7 != 0) {
                this.mTargetRect.right += (float) i7;
            }
            int i8 = this.mPaddingBottom;
            if (i8 != 0) {
                this.mTargetRect.bottom += (float) i8;
            }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            this.mTargetRect.offset(0.0f, (float) i);
        ...
        if (!this.mOverlayTarget) {
            ...
            if (i2 == 0) {
                ...
                int i3 = this.mCorner;
                canvas2.drawRoundRect(rectF, (float) i3, (float) i3, this.mEraser);
            } else if (i2 == 1) {
                ...
                RectF rectF2 = this.mTargetRect;
                int i4 = this.mCorner;
                canvas3.drawRoundRect(rectF2, (float) i4, (float) i4, this.mEraser);
            } else {
