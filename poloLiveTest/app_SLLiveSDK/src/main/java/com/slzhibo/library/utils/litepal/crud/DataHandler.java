...
//        try {
//            try {
//                t = this.mDatabase.query(str, strArr, getWhereClause(strArr2), getWhereArgs(strArr2), null, null, null);
//            } catch (Exception e2) {
//                e = e2;
//            }
//        } catch (Throwable th2) {
...
//        try {
////            if (t.moveToFirst()) {
////                t = (T) t.getClass().getMethod(genGetColumnMethod((Class<?>) cls), Integer.TYPE).invoke(t, 0);
////            }
////            if (t != 0) {
////                t.close();
////            }
...
//    }
    ...
    public <T> T mathQuery(String str, String[] strArr, String[] strArr2, Class<T> cls) throws Throwable {
        ...
        T t = null;
        try {
            Cursor cursor = this.mDatabase.query(str, strArr, getWhereClause(strArr2), getWhereArgs(strArr2), null, null, null);
            try {
                if (cursor.moveToFirst()) {
    ...
    */
//    protected void setGenericValueToModel(LitePalSupport r21, List<Field> r22, java.util.Map<Field, com.slzhibo.library.utils.litepal.tablemanager.model.GenericModel> r23) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
//        /*
//            r20 = this;
//            r7 = r20
//            r0 = r23
...
//            com.slzhibo.library.utils.litepal.tablemanager.model.GenericModel r2 = (com.slzhibo.library.utils.litepal.tablemanager.model.GenericModel) r2
//            if (r2 != 0) goto L_0x006c
//            java.lang.String r2 = r7.getGenericTypeName(r9)
//            java.lang.String r3 = r21.getClassName()
//            boolean r2 = r3.equals(r2)
//            if (r2 == 0) goto L_0x0033
//            java.lang.String r2 = com.slzhibo.library.utils.litepal.util.DBUtility.getM2MSelfRefColumnName(r9)
//            java.lang.String r3 = "getLong"
//            goto L_0x003f
//        L_0x0033:
//            java.lang.String r2 = r9.getName()
//            java.lang.String r2 = com.slzhibo.library.utils.litepal.util.DBUtility.convertToValidColumnName(r2)
//            java.lang.String r3 = r7.genGetColumnMethod(r9)
//        L_0x003f:
//            java.lang.String r4 = r21.getClassName()
//            java.lang.String r5 = r9.getName()
//            java.lang.String r4 = com.slzhibo.library.utils.litepal.util.DBUtility.getGenericTableName(r4, r5)
//            java.lang.String r5 = r21.getClassName()
//            java.lang.String r5 = com.slzhibo.library.utils.litepal.util.DBUtility.getGenericValueIdColumnName(r5)
//            com.slzhibo.library.utils.litepal.tablemanager.model.GenericModel r6 = new com.slzhibo.library.utils.litepal.tablemanager.model.GenericModel
//            r6.<init>()
//            r6.setTableName(r4)
...
//        L_0x0080:
//            r11 = r4
//            android.database.sqlite.SQLiteDatabase r10 = r7.mDatabase     // Catch: all -> 0x00d8
//            r12 = 0
...
//            java.lang.String r13 = r2.toString()     // Catch: all -> 0x00d8
//            r2 = 1
//            java.lang.String[] r14 = new java.lang.String[r2]     // Catch: all -> 0x00d8
//            r2 = 0
//            long r3 = r21.getBaseObjId()     // Catch: all -> 0x00d8
//            java.lang.String r3 = java.lang.String.valueOf(r3)     // Catch: all -> 0x00d8
//            r14[r2] = r3     // Catch: all -> 0x00d8
//            r15 = 0
//            r16 = 0
//            r17 = 0
//            android.database.Cursor r10 = r10.query(r11, r12, r13, r14, r15, r16, r17)     // Catch: all -> 0x00d8
//            boolean r1 = r10.moveToFirst()     // Catch: all -> 0x00d5
//            if (r1 == 0) goto L_0x00ce
//        L_0x00b2:
//            java.lang.String r1 = com.slzhibo.library.utils.litepal.util.BaseUtility.changeCase(r18)     // Catch: all -> 0x00d5
//            int r4 = r10.getColumnIndex(r1)     // Catch: all -> 0x00d5
//            r1 = -1
...
//        L_0x00c8:
//            boolean r1 = r10.moveToNext()     // Catch: all -> 0x00d5
...
//            return
//        */
//        throw new UnsupportedOperationException("Method not decompiled: com.slzhibo.library.utils.litepal.crud.DataHandler.setGenericValueToModel(com.slzhibo.library.utils.litepal.crud.LitePalSupport, java.util.List, java.util.Map):void");
//    }
        ...
        for (Field field : list) {
            ...
            if (genericModel == null) {
                if (litePalSupport.getClassName().equals(getGenericTypeName(field))) {
                    str6 = DBUtility.getM2MSelfRefColumnName(field);
                    str5 = "getLong";
                } else {
                    str6 = DBUtility.convertToValidColumnName(field.getName());
                    str5 = genGetColumnMethod(field);
                }
                str4 = DBUtility.getGenericTableName(litePalSupport.getClassName(), field.getName());
                str3 = DBUtility.getGenericValueIdColumnName(litePalSupport.getClassName());
                GenericModel genericModel2 = new GenericModel();
                genericModel2.setTableName(str4);
                genericModel2.setValueColumnName(str6);
                genericModel2.setValueIdColumnName(str3);
                genericModel2.setGetMethodName(str5);
                map.put(field, genericModel2);
                str2 = str6;
                str = str5;
            } else {
                str4 = genericModel.getTableName();
                String valueColumnName = genericModel.getValueColumnName();
                str3 = genericModel.getValueIdColumnName();
                str = genericModel.getGetMethodName();
                str2 = valueColumnName;
            }
            try {
                SQLiteDatabase sQLiteDatabase = this.mDatabase;
                Cursor query = sQLiteDatabase.query(str4, null, str3 + " = ?", new String[]{String.valueOf(litePalSupport.getBaseObjId())}, null, null, null);
                try {
                    if (query.moveToFirst()) {
                        do {
                            int columnIndex = query.getColumnIndex(BaseUtility.changeCase(str2));
                            if (columnIndex != -1) {
                                setToModelByReflection(litePalSupport, field, columnIndex, str, query);
                            }
    ...
    private String genGetColumnMethod(Class<?> cls) {
        ...
        if (!"getBoolean".equals(str2)) {
            if ("getChar".equals(str2) || "getCharacter".equals(str2)) {
                return "getString";
            }
            if ("getDate".equals(str2)) {
                return "getLong";
            }
            if (!"getInteger".equals(str2)) {
                return "getbyte[]".equalsIgnoreCase(str2) ? "getBlob" : str2;
            }
        }
        return "getInt";
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x0172 A[LOOP:1: B:21:0x00ef->B:41:0x0172, LOOP_END] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:78:0x016b A[EDGE_INSN: B:78:0x016b->B:40:0x016b ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
//    private void setAssociatedModel(LitePalSupport r27) {
//        /*
//            Method dump skipped, instructions count: 428
//            To view this dump change 'Code comments level' option to 'DEBUG'
//        */
//        throw new UnsupportedOperationException("Method not decompiled: com.slzhibo.library.utils.litepal.crud.DataHandler.setAssociatedModel(com.slzhibo.library.utils.litepal.crud.LitePalSupport):void");
//    }

    private void setAssociatedModel(LitePalSupport litePalSupport) throws Throwable {
        Cursor cursor3;
        Cursor cursor4;
        ...
        if (list != null) {
            for (AssociationsInfo associationsInfo : list) {
                ...
                if (z) {
                    ...
                    sb.append(tableName);
                    sb.append("_id = ?");
                    cursor3 = Operator.findBySQL(BaseUtility.changeCase(sb.toString()), String.valueOf(litePalSupport.getBaseObjId()));
                } else {
                    ...
                    cursor3 = sQLiteDatabase.query(changeCase, null, foreignKeyColumnName + "=?", new String[]{String.valueOf(litePalSupport.getBaseObjId())}, null, null, null, null);
                }
                ...
                if (cursor5 != null) {
                    ...
                    if (cursor5.moveToFirst()) {
                        ...
                        while (true) {
                            ...
                            giveBaseObjIdValue(litePalSupport2, cursor5.getLong(cursor5.getColumnIndexOrThrow("id")));
                            map = hashMap;
                            cursor4 = cursor5;

                            setValueToModel(litePalSupport2, supportedFields, null, cursor5, sparseArray);
