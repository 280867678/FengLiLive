...
public class NumberUtils {
    ...
    public static int dp2px(float f) {
        return (int) ((f * SLLiveSDK.getSingleton().getApplication().getResources().getDisplayMetrics().density) + 0.5f);
    }
    ...
    public static String formatStarNum(long j, boolean z) {
        ...
        if (j > 10000000) {
            ...
            return decimalFormat.format(d2) + SystemUtils.getResString(R.string.fq_count_unit_qw);
        } else if (j < 10000) {
            return "0";
        } else {
            double d3 = j;
            ...
            return CovertFloat(decimalFormat2.format(d4)) + SystemUtils.getResString(R.string.fq_count_unit_w);
        }
    }
