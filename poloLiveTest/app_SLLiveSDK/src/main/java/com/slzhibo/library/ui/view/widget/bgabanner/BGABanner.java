...
import com.slzhibo.library.ui.view.widget.bgabanner.transformer.BGAPageTransformer;
...
/* renamed from: com.slzhibo.library.ui.view.widget.bgabanner.BGABanner */
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    /* renamed from: com.slzhibo.library.ui.view.widget.bgabanner.BGABanner$Adapter */
    /* loaded from: classes6.dex */
    public interface Adapter<V extends View, M> {
        void fillBannerItem(BGABanner bGABanner, V v, @Nullable M m, int i);
    }

    /* renamed from: com.slzhibo.library.ui.view.widget.bgabanner.BGABanner$Delegate */
    /* loaded from: classes6.dex */
    public interface Delegate<V extends View, M> {
        void onBannerItemClick(BGABanner bGABanner, V v, @Nullable M m, int i);
    }

    /* renamed from: com.slzhibo.library.ui.view.widget.bgabanner.BGABanner$GuideDelegate */
    /* loaded from: classes6.dex */
    public interface GuideDelegate {
        void onClickEnterOrSkip();
    }

    @Override // com.slzhibo.library.p115ui.view.widget.bgabanner.BGAViewPager.AutoPlayDelegate
    ...
    public BGABanner(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mPointDrawableResId = R.drawable.fq_bga_banner_selector_point_solid;
        ...
        this.mGuideOnNoDoubleClickListener = new BGAOnNoDoubleClickListener() { // from class: com.slzhibo.library.ui.view.widget.bgabanner.BGABanner.1
...
//        this.mAutoPlayTask = new AutoPlayTask();
    ...
    private void initCustomAttr(int i, TypedArray typedArray) {
        ...
        if (i == R.styleable.BGABanner_banner_pointDrawable) {
            this.mPointDrawableResId = typedArray.getResourceId(i, R.drawable.fq_bga_banner_selector_point_solid);
        ...
        } else if (i == 0 && (i2 = typedArray.getInt(i, -1)) >= 0) {
    ...
    private void initView(Context context) {
        ...
        if (this.mIsNumberIndicator) {
            ...
            this.mNumberIndicatorTv.setId(2131296637);
            ...
            this.mPointRealContainerLl.setId(2131296637);
        ...
        if (i3 == 3) {
            ...
            layoutParams3.addRule(1, 2131296637);
            this.mTipTv.setGravity(21);
        } else if (i3 == 5) {
            layoutParams2.addRule(11);
            layoutParams3.addRule(0, 2131296637);
        } else {
    ...
    public void setData(List<? extends Object> list, List<String> list2) {
        setData(R.layout.fq_bga_banner_item_image, list, list2);
    }
    ...
    public void setIndicatorVisibility(boolean z) {
        this.mPointContainerRl.setVisibility(z ? View.VISIBLE : View.GONE);
    }
    ...
    protected void onMeasure(int i, int i2) {
        try {
            if (this.mAspectRatio > 0.0f) {
                i2 = View.MeasureSpec.makeMeasureSpec((int) (MeasureSpec.getSize(i) / this.mAspectRatio), MeasureSpec.EXACTLY);
            }
    ...
    private void switchToPoint(int i) {
        ...
        if (this.mTipTv != null) {
            ...
            if (list == null || list.size() < 1 || i >= this.mTips.size()) {
                this.mTipTv.setVisibility(View.GONE);
            } else {
                this.mTipTv.setVisibility(View.VISIBLE);
...
//                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.slzhibo.library.ui.view.widget.bgabanner.BGABanner$PageAdapter */
    /* loaded from: classes6.dex */
    public class PageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            if (BGABanner.this.mDelegate != null) {
                view.setOnClickListener(new BGAOnNoDoubleClickListener() { // from class: com.slzhibo.library.ui.view.widget.bgabanner.BGABanner.PageAdapter.1
                    @Override // com.slzhibo.library.p115ui.view.widget.bgabanner.BGAOnNoDoubleClickListener
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.slzhibo.library.ui.view.widget.bgabanner.BGABanner$AutoPlayTask */
    /* loaded from: classes6.dex */
