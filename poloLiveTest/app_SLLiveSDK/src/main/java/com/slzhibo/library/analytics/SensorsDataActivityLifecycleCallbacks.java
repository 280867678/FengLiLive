...
import com.slzhibo.library.analytics.data.DbParams;
...
class SensorsDataActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    private Runnable timer = new Runnable() { // from class: com.slzhibo.library.analytics.SensorsDataActivityLifecycleCallbacks.1
    ...
    private void initHandler() {
        try {
            ...
            handlerThread.start();
            this.handler = new Handler(handlerThread.getLooper()) { // from class: com.slzhibo.library.analytics.SensorsDataActivityLifecycleCallbacks.2
