...
public class QueryHandler extends DataHandler {
    ...
    public int onCount(String str, String[] strArr) throws Throwable {
    ...
    public double onAverage(String str, String str2, String[] strArr) throws Throwable {
        BaseUtility.checkConditionsCorrect(strArr);
        if (strArr != null && strArr.length > 0) {
            strArr[0] = DBUtility.convertWhereClauseToColumnName(strArr[0]);
        }
    ...
    public <T> T onMax(String str, String str2, String[] strArr, Class<T> cls) throws Throwable {
        BaseUtility.checkConditionsCorrect(strArr);
        if (strArr != null && strArr.length > 0) {
            strArr[0] = DBUtility.convertWhereClauseToColumnName(strArr[0]);
        }
    ...
    public <T> T onMin(String str, String str2, String[] strArr, Class<T> cls) throws Throwable {
        BaseUtility.checkConditionsCorrect(strArr);
        if (strArr != null && strArr.length > 0) {
            strArr[0] = DBUtility.convertWhereClauseToColumnName(strArr[0]);
        }
    ...
    public <T> T onSum(String str, String str2, String[] strArr, Class<T> cls) throws Throwable {
        BaseUtility.checkConditionsCorrect(strArr);
        if (strArr != null && strArr.length > 0) {
            strArr[0] = DBUtility.convertWhereClauseToColumnName(strArr[0]);
        }
