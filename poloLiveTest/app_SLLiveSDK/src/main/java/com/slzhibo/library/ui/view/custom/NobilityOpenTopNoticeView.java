...
public class NobilityOpenTopNoticeView extends LinearLayout {
    ...
    public void initData(SocketMessageEvent.ResultData resultData, String str) {
        ...
        if (TextUtils.equals(resultData.type, "2")) {
            str2 = this.mContext.getString(R.string.fq_nobility_renewal, nobilityBadgeName);
        } else {
            str2 = this.mContext.getString(R.string.fq_nobility_opened, nobilityBadgeName);
        }
        ...
        if (i == 7) {
            ...
            if (TextUtils.equals(resultData.forwardLiveId, ImageSet.ID_ALL_MEDIA)) {
                this.tvNobilityOpenTips.setText(Html.fromHtml(this.mContext.getString(R.string.fq_nobility_open_notice_tips_2_3, formatUserNickName, str2)));
            } else if (TextUtils.equals(resultData.forwardLiveId, str)) {
                this.tvNobilityOpenTips.setText(Html.fromHtml(this.mContext.getString(R.string.fq_nobility_open_notice_tips_2_2, formatUserNickName, str2)));
            } else {
                this.tvNobilityOpenTips.setText(Html.fromHtml(this.mContext.getString(R.string.fq_nobility_open_notice_tips_2, formatUserNickName, formatUserNickName2, str2)));
            }
        } else {
            this.tvNobilityOpenTips.setTextColor(ContextCompat.getColor(this.mContext, R.color.fq_text_white_color));
            if (TextUtils.equals(resultData.forwardLiveId, ImageSet.ID_ALL_MEDIA)) {
                this.tvNobilityOpenTips.setText(Html.fromHtml(this.mContext.getString(R.string.fq_nobility_open_notice_tips_1_3, formatUserNickName, str2)));
            } else if (TextUtils.equals(resultData.forwardLiveId, str)) {
                this.tvNobilityOpenTips.setText(Html.fromHtml(this.mContext.getString(R.string.fq_nobility_open_notice_tips_1_2, formatUserNickName, str2)));
            } else {
                this.tvNobilityOpenTips.setText(Html.fromHtml(this.mContext.getString(R.string.fq_nobility_open_notice_tips_1, formatUserNickName, formatUserNickName2, str2)));
            }
        }
    }
