...
public class UserInfoManager {
    ...
    public void loadUserInfo(UserEntity userEntity) {
        if (userEntity != null) {
            ...
            Log.e("UserInfoManager:","loadUserInfo");
        }
    }
    ...
    public String getAppId() {
        return SPUtils.getInstance("fq_user").getString("appId", "");
    }

    public void setAppId(String str) {
        SPUtils.getInstance("fq_user").put("appId", str);
    }
    ...
    public void setUserRole(String str) {
        SPUtils.getInstance("fq_user").put("userRole", str);
    }

    public String getUserRole() {
        return SPUtils.getInstance("fq_user").getString("userRole");
    }
}
