...
public class LotteryTurntableInfoEntity implements Parcelable {
    public static final Creator<LotteryTurntableInfoEntity> CREATOR = new Creator<LotteryTurntableInfoEntity>() { // from class: com.slzhibo.library.model.LotteryTurntableInfoEntity.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public LotteryTurntableInfoEntity createFromParcel(Parcel parcel) {
            return new LotteryTurntableInfoEntity(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public LotteryTurntableInfoEntity[] newArray(int i) {
