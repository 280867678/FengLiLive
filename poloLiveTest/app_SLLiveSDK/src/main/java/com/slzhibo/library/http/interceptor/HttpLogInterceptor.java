...
public class HttpLogInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (isEncrypt(this.jsonParser, readString)) {
            Log.e("HttpLogInterceptor","");
            EncryptHttpResultModel encryptHttpResultModel = (EncryptHttpResultModel) GsonUtils.fromJson(readString,  EncryptHttpResultModel.class);
    ...
    private boolean isEncrypt(JsonParser jsonParser, String str) {
        try {
            String json = GsonUtils.toJson(((CustomGsonResultModel) GsonUtils.fromJson(str, CustomGsonResultModel.class)).data);
