...
public class StartLiveVerifyEntity implements Parcelable {
    public static final Creator<StartLiveVerifyEntity> CREATOR = new Creator<StartLiveVerifyEntity>() { // from class: com.slzhibo.library.model.StartLiveVerifyEntity.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public StartLiveVerifyEntity createFromParcel(Parcel parcel) {
            return new StartLiveVerifyEntity(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public StartLiveVerifyEntity[] newArray(int i) {
