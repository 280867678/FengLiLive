...
public class WindowHelper {
    ...
    private static Comparator<View> sViewSizeComparator = new Comparator<View>() { // from class: com.slzhibo.library.analytics.util.WindowHelper.1
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:38:0x0093 -> B:40:0x0093). Please submit an issue!!! */
