...
public class TurntableMode implements Parcelable {
    public static final Creator<TurntableMode> CREATOR = new Creator<TurntableMode>() { // from class: com.slzhibo.library.model.TurntableMode.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public TurntableMode createFromParcel(Parcel parcel) {
            return new TurntableMode(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public TurntableMode[] newArray(int i) {
