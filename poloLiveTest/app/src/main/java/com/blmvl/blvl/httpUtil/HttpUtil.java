...
//                EventBus.m309d().m320a(new FollowEvent(this.f12977a, intValue));
    ...
    public static void m9689f(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/videoincome/hottest", "getHotWorkIncomeList").params(m9679h(i))).execute(aVar);
    }

    /* renamed from: g */
    public static void m9683g(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/videoincome/newest", "getLatestWorkIncomeList").params(m9675i(i))).execute(aVar);
    }
    ...
    public static void m9661m(HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/product/list", "getSystemNoticeList").params(m9691f())).execute(aVar);
    }
    ...
    public static void m9665l(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/works/upShelves", "onShelf").params(m9657o(i))).execute(aVar);
    }

    /* renamed from: m */
    public static void m9662m(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/works/downShelves", "removeShelf").params(m9651q(i))).execute(aVar);
    }

    /* renamed from: n */
    public static void m9659n(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/system/appclick", "appDownloadClick").params(m9648r(i))).execute(aVar);
    }
    ...
    public static void m9645s(HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/mv/uploadAnswer", "getUploadRuleAnswer").params(m9685g())).execute(aVar);
    }
    ...
    public static HttpParams m9695e(String str, String str2) {
        HttpParams a = m9789a();
        a.put("nickname", str, new boolean[0]);
        a.put("person_signnatrue", str2, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9717c(String str, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/system/exchange", "writeExchangeCode").params(m9687f(str))).execute(aVar);
    }

    /* renamed from: f */
    public static HttpParams m9687f(String str) {
        HttpParams a = m9789a();
        a.put("code", str, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9678h(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/proxy/userMoney", "getPromoteIncomeInfo").params(m9672j(i))).execute(aVar);
    }
    ...
    public static void m9656o(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/mv/toggleTop", "toggleTop").params(m9646s(i))).execute(aVar);
    }

    /* renamed from: p */
    public static void m9653p(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/usertopic/toggle_top", "topVideoCollectAction").params(m9644t(i))).execute(aVar);
    }

    /* renamed from: q */
    public static void m9650q(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/userbuy/checkByTicket", "ticketBuyCoinVideo").params(m9669k(i))).execute(aVar);
    }

    /* renamed from: b */
    public static HttpParams m9728b(String str, String str2, String str3) {
        HttpParams a = m9789a();
        a.put("mobile_prefix", str, new boolean[0]);
        a.put("phone", str2, new boolean[0]);
        a.put("verify_code", str3, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9713c(String str, String str2, String str3, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/sms", "getFindPwdCode").params(m9728b(str, str2, str3))).execute(aVar);
    }

    /* renamed from: e */
    public static HttpParams m9696e(String str) {
        HttpParams a = m9789a();
        a.put("thumb", str, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9686f(String str, String str2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/login", "switch_account").params(m9716c(str, str2))).execute(aVar);
    }

    /* renamed from: g */
    public static void m9680g(String str, String str2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/personal", "updateUserInfo").params(m9695e(str, str2))).execute(aVar);
    }

    /* renamed from: h */
    public static void m9676h(String str, String str2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/hasPhone", "verify_phone_num").params(m9704d(str, str2))).execute(aVar);
    }
    ...
    public static HttpParams m9767a(HttpParams httpParams) {
        try {
            ...
            L.m9079a("請求參數加密後=====" + httpParams.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return httpParams;
    ...
    public static HttpParams m9716c(String str, String str2) {
        HttpParams a = m9789a();
        a.put("phone", str, new boolean[0]);
        a.put("password", str2, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9688f(HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/mv/report_type", "complaintOptionsList").params(m9712d())).execute(aVar);
    }
    ...
    public static void m9729b(String str, String str2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/login_account", "loginAction").params(m9759a(str, str2))).execute(aVar);
    }

    /* renamed from: d */
    public static void m9707d(HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/product/list", "getCoinRechargeList").params(m9725c())).execute(aVar);
    }
    ...
    public static HttpParams m9714c(String str, String str2, String str3) {
        ...
        a.put("phone", str, new boolean[0]);
        a.put("password", str2, new boolean[0]);
        a.put("identify", str3, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9732b(String str, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/thumb", "updateAvatar").params(m9696e(str))).execute(aVar);
    }

    /* renamed from: d */
    public static void m9705d(String str, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/invitation", "writeInviteCode").params(m9681g(str))).execute(aVar);
    }

    /* renamed from: e */
    public static void m9698e(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/game/enter", "getGameInfo").params(m9684g(i))).execute(aVar);
    }

    /* renamed from: b */
    public static void m9730b(String str, String str2, int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/helper/feedSave", "onlineFeedback").params(m9758a(str, str2, i))).execute(aVar);
    }

    /* renamed from: d */
    public static void m9709d(int i, int i2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/videoIncome/videoIncomeList", "getVideoIncomeDetail").params(m9710d(i, i2))).execute(aVar);
    }

    /* renamed from: c */
    public static void m9722c(int i, int i2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/comments/list", "getVideoCommentList").params(m9723c(i, i2))).execute(aVar);
    }
    ...
    public static void m9692e(String str, String str2, String str3, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/game/transAccount", "transfer_balance").params(m9693e(str, str2, str3))).execute(aVar);
    }

    /* renamed from: b */
    public static void m9741b(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/Chargevideo/buy", "get_coin_video_info").params(m9699e(i))).execute(aVar);
    }

    /* renamed from: d */
    public static HttpParams m9710d(int i, int i2) {
        HttpParams a = m9789a();
        a.put("page", i2, new boolean[0]);
        a.put("vid", i, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static HttpParams m9693e(String str, String str2, String str3) {
        HttpParams a = m9789a();
        a.put("from_account", str, new boolean[0]);
        a.put("to_account", str2, new boolean[0]);
        a.put("account_value", str3, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9701d(String str, String str2, String str3, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/sms", "getRegisterCode").params(m9702d(str, str2, str3))).execute(aVar);
    }
    ...
    public static void m9756a(String str, String str2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b(str, str).params(m9719c(str2))).execute(aVar);
    }
    ...
    public static void m9715c(String str, String str2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/changePassword", "modPwd").params(m9731b(str, str2))).execute(aVar);
    }
    ...
    public static void m9718c(String str, int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/mv/report_push", "submitComplaintOptions").params(m9734b(str, i))).execute(aVar);
    }
    ...
    public static void m9773a(int i, String str, String str2, String str3, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/Api/p/createP", "getPayLink").params(m9774a(i, str, str2, str3))).execute(aVar);
    }

    /* renamed from: c */
    public static void m9721c(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/usertopic/delete", "delVideoCollectAction").params(m9788a(i))).execute(aVar);
    }

    /* renamed from: b */
    public static HttpParams m9731b(String str, String str2) {
        HttpParams a = m9789a();
        a.put("oldPassword", str, new boolean[0]);
        a.put("password", str2, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static HttpParams m9774a(int i, String str, String str2, String str3) {
        HttpParams a = m9789a();
        a.put("product_id", i, new boolean[0]);
        a.put("pt", str, new boolean[0]);
        a.put("pw", str2, new boolean[0]);
        a.put("is_sdk", "0", new boolean[0]);
        a.put("verify_code", str3, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9703d(String str, String str2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/register_account", "registerAction").params(m9759a(str, str2))).execute(aVar);
    }
    ...
    public static HttpParams m9734b(String str, int i) {
        HttpParams a = m9789a();
        a.put("content", str, new boolean[0]);
        a.put("mv_id", i, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9708d(int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/p/delAccount", "delWithdrawAccount").params(m9744b(i))).execute(aVar);
    }

    /* renamed from: a */
    public static void m9757a(String str, String str2, int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b(str, str).params(m9781a(i, str2))).execute(aVar);
    }

    /* renamed from: b */
    public static void m9742b(int i, int i2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/topic/mv", "getVideoCollect").params(m9743b(i, i2))).execute(aVar);
    }
    ...
    public static void m9733b(String str, int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/usertopic/listmv", "getForSelectVideoList").params(m9763a(str, i))).execute(aVar);
    }
    ...
    public static void m9746a(String str, String str2, String str3, String str4, String str5, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/register", "register").params(m9747a(str, str2, str3, str4, str5))).execute(aVar);
    }
    ...
    public static HttpParams m9747a(String str, String str2, String str3, String str4, String str5) {
        ...
        a.put("phone", str2, new boolean[0]);
        a.put("identify", str3, new boolean[0]);
        a.put("password", str4, new boolean[0]);
        a.put("aff", str5, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9726b(String str, String str2, String str3, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/game/draw", "gameWithdraw").params(m9755a(str, str2, str3))).execute(aVar);
    }

    /* renamed from: a */
    public static HttpParams m9759a(String str, String str2) {
        HttpParams a = m9789a();
        a.put("username", str, new boolean[0]);
        a.put("password", str2, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9752a(String str, String str2, String str3, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/users/findPassword", "findPwd").params(m9714c(str, str2, str3))).execute(aVar);
    }
    ...
    public static HttpParams m9758a(String str, String str2, int i) {
        HttpParams a = m9789a();
        a.put("thumb", str, new boolean[0]);
        a.put("content", str2, new boolean[0]);
        a.put("platform", i, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9786a(int i, int i2, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/helper/feedList", "onlineFeedbackList").params(m9787a(i, i2))).execute(aVar);
    }
    ...
    public static HttpParams m9787a(int i, int i2) {
        HttpParams a = m9789a();
        a.put("page", i, new boolean[0]);
        a.put("platform", i2, new boolean[0]);
        m9767a(a);
        return a;
    }
...
//    }
    ...
    public static void m9768a(UploadVideoBean uploadVideoBean, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/mv/upload", "postVideo").params(m9769a(uploadVideoBean))).execute(aVar);
    }

    /* renamed from: a */
    public static HttpParams m9769a(UploadVideoBean uploadVideoBean) {
        HttpParams a = m9789a();
        a.put("title", uploadVideoBean.title, new boolean[0]);
        a.put("img_url", uploadVideoBean.thumbUrl, new boolean[0]);
        a.put("url", uploadVideoBean.videoUrl, new boolean[0]);
        a.put("tags", uploadVideoBean.tags, new boolean[0]);
        a.put("thumb_height", uploadVideoBean.thumbHeight, new boolean[0]);
        a.put("thumb_width", uploadVideoBean.thumbWidth, new boolean[0]);
        a.put("coins", uploadVideoBean.coins, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9753a(String str, String str2, String str3, int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/p/addAccount", "addWithdrawAccount").params(m9754a(str, str2, str3, i))).execute(aVar);
    }

    /* renamed from: a */
    public static HttpParams m9754a(String str, String str2, String str3, int i) {
        HttpParams a = m9789a();
        a.put("account", str, new boolean[0]);
        a.put("name", str2, new boolean[0]);
        a.put("account_bank", str3, new boolean[0]);
        a.put("type", i, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9784a(int i, int i2, String str, String str2, String str3, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/proxy/withdraw", "withdrawAction").params(m9785a(i, i2, str, str2, str3))).execute(aVar);
    }

    /* renamed from: a */
    public static HttpParams m9785a(int i, int i2, String str, String str2, String str3) {
        HttpParams a = m9789a();
        a.put("withdraw_from", i, new boolean[0]);
        a.put("withdraw_type", i2, new boolean[0]);
        a.put("withdraw_account", str, new boolean[0]);
        a.put("withdraw_name", str2, new boolean[0]);
        a.put("withdraw_amount", str3, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9771a(long j, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/mv/long", "getLongDetail").params(m9772a(j))).execute(aVar);
    }
    ...
    public static void m9762a(String str, int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b(str, str).params(m9690f(i))).execute(aVar);
    }
    ...
    public static void m9749a(String str, String str2, String str3, String str4, int i, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/usertopic/create", "createVideoCollectAction").params(m9750a(str, str2, str3, str4, i))).execute(aVar);
    }

    /* renamed from: a */
    public static HttpParams m9750a(String str, String str2, String str3, String str4, int i) {
        HttpParams a = m9789a();
        a.put("title", str, new boolean[0]);
        a.put("desc", str2, new boolean[0]);
        a.put("image", str3, new boolean[0]);
        a.put("mv_id", str4, new boolean[0]);
        a.put("determine", i, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9776a(int i, String str, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/usertopic/update", "updateVideoCollectVideoList").params(m9740b(i, str))).execute(aVar);
    }
    ...
    public static HttpParams m9755a(String str, String str2, String str3) {
        HttpParams a = m9789a();
        a.put("bankcard", str, new boolean[0]);
        a.put("name", str2, new boolean[0]);
        a.put("amount", str3, new boolean[0]);
        m9767a(a);
        return a;
    }
    ...
    public static void m9748a(String str, String str2, String str3, String str4, HttpCallback aVar) {
        ((PostRequest) C4220b.m9794b().m9793b("/api/game/pay", "gameRecharge").params(m9751a(str, str2, str3, str4))).execute(aVar);
    }

    /* renamed from: a */
    public static HttpParams m9751a(String str, String str2, String str3, String str4) {
        HttpParams a = m9789a();
        a.put("amount", str, new boolean[0]);
        a.put("type", str2, new boolean[0]);
        a.put("way", str3, new boolean[0]);
        a.put("verify_code", str4, new boolean[0]);
        m9767a(a);
        return a;
    }
}
