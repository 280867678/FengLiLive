...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static final String TAG = "com.tomato.ijk.media.player.IjkMediaPlayer";
    ...
    public static final IjkLibLoader sLocalLibLoader = new IjkLibLoader() { // from class: com.tomato.ijk.media.player.IjkMediaPlayer.1
    ...
    public static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer != null) {
                ...
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i == 1) {
                        ...
                        if (i == 100) {
                            DebugLog.m11185e(IjkMediaPlayer.TAG, "Error (" + message.arg1 + "," + message.arg2 + ")");
                            ...
                            if (message.arg1 == 3) {
                                DebugLog.m11183i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                            }
                            ijkMediaPlayer.notifyOnInfo(message.arg1, message.arg2);
                            return;
                        } else if (i != 10001) {
                            DebugLog.m11185e(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
                            return;
                        } else {
            ...
            DebugLog.m11179w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
        }
    }
...
//                LoggerUtil.d(TAG,e.getMessage());
                Log.e("IjkMediaPlayer：prepareAsync：",t.getMessage());
                Log.e("IjkMediaPlayer：prepareAsync：",t.toString());
            }
...
//                LoggerUtil.d(TAG,e.getMessage());
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m11179w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m11179w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    public void setWakeMode(Context context, int i) {
        ...
        this.mWakeLock = ((PowerManager) context.getSystemService(Context.POWER_SERVICE)).newWakeLock(i | 536870912, IjkMediaPlayer.class.getName());
