...
public class PropConfigEntity implements Parcelable {
    public static final Creator<PropConfigEntity> CREATOR = new Creator<PropConfigEntity>() { // from class: com.slzhibo.library.model.PropConfigEntity.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public PropConfigEntity createFromParcel(Parcel parcel) {
            return new PropConfigEntity(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public PropConfigEntity[] newArray(int i) {
