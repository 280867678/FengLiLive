...
public class ExpenseMenuEntity {
    ...
    private String shelfProductExpensePrice = "";
    private String videoCallExpensePrice = "";
    ...
    public String getProductExpensePrice() {
        return TextUtils.isEmpty(this.shelfProductExpensePrice) ? "0" : this.shelfProductExpensePrice;
    }

    public String getVideoCallExpensePrice() {
        return TextUtils.isEmpty(this.videoCallExpensePrice) ? "0" : this.videoCallExpensePrice;
    }
