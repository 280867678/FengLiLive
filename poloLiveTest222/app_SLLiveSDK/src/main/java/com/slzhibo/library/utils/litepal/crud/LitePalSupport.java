...
public class LitePalSupport {
    ...
    public UpdateOrDeleteExecutor deleteAsync() {
        ...
        updateOrDeleteExecutor.submit(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.1
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int delete = LitePalSupport.this.delete();
                    if (updateOrDeleteExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.1.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public UpdateOrDeleteExecutor updateAsync(final long j) {
        final UpdateOrDeleteExecutor updateOrDeleteExecutor = new UpdateOrDeleteExecutor();
        updateOrDeleteExecutor.submit(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.2
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int update = LitePalSupport.this.update(j);
                    if (updateOrDeleteExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.2.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public UpdateOrDeleteExecutor updateAllAsync(final String... strArr) {
        final UpdateOrDeleteExecutor updateOrDeleteExecutor = new UpdateOrDeleteExecutor();
        updateOrDeleteExecutor.submit(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.3
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final int updateAll = LitePalSupport.this.updateAll(strArr);
                    if (updateOrDeleteExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.3.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    public SaveExecutor saveAsync() {
        ...
        saveExecutor.submit(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.4
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final boolean save = LitePalSupport.this.save();
                    if (saveExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.4.1
                            @Override // java.lang.Runnable
                            public void run() {
    ...
    @Deprecated
    public boolean saveIfNotExist(String... strArr) throws Throwable {
    ...
    public boolean saveOrUpdate(String... strArr) {
        synchronized (LitePalSupport.class) {
            ...
            List<LitePalSupport> find = (List<LitePalSupport>)Operator.where(strArr).find(getClass());
            if (find.isEmpty()) {
                return save();
            }
            SQLiteDatabase database = Connector.getDatabase();
    ...
    public SaveExecutor saveOrUpdateAsync(final String... strArr) {
        final SaveExecutor saveExecutor = new SaveExecutor();
        saveExecutor.submit(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.5
            @Override // java.lang.Runnable
            public void run() {
                synchronized (LitePalSupport.class) {
                    final boolean saveOrUpdate = LitePalSupport.this.saveOrUpdate(strArr);
                    if (saveExecutor.getListener() != null) {
                        Operator.getHandler().post(new Runnable() { // from class: com.slzhibo.library.utils.litepal.crud.LitePalSupport.5.1
                            @Override // java.lang.Runnable
                            public void run() {
