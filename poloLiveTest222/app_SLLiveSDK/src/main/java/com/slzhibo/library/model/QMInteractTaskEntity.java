...
public class QMInteractTaskEntity implements Parcelable {
    public static final Creator<QMInteractTaskEntity> CREATOR = new Creator<QMInteractTaskEntity>() { // from class: com.slzhibo.library.model.QMInteractTaskEntity.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public QMInteractTaskEntity createFromParcel(Parcel parcel) {
            return new QMInteractTaskEntity(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public QMInteractTaskEntity[] newArray(int i) {
