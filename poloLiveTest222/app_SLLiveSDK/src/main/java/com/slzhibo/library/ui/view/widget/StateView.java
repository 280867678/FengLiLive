...
public class StateView extends View {
            ...
            if (parent == null) {
                ...
                if (z2) {
                    ...
                    if (viewGroup.getChildCount() == 1) {
                        ...
                        ((WindowManager) viewGroup.getContext().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay().getMetrics(displayMetrics);
    ...
    public View showRetry() {
        if (this.mRetryView == null) {
            ...
            if (findViewById != null) {
                findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.slzhibo.library.ui.view.widget.StateView.1
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        if (StateView.this.mRetryClickListener != null) {
                            StateView.this.showLoading();
                            findViewById.postDelayed(new Runnable() { // from class: com.slzhibo.library.ui.view.widget.StateView.1.1
                ...
                this.mRetryView.setOnClickListener(new View.OnClickListener() { // from class: com.slzhibo.library.ui.view.widget.StateView.2
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        if (StateView.this.mRetryClickListener != null) {
                            StateView.this.showLoading();
                            StateView.this.mRetryView.postDelayed(new Runnable() { // from class: com.slzhibo.library.ui.view.widget.StateView.2.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    StateView.this.mRetryClickListener.onRetryClick();
                                }
    ...
    private void startAnimation(final View view) {
        ...
        showAnimation.addListener(new AnimatorListenerAdapter() { // from class: com.slzhibo.library.ui.view.widget.StateView.3
