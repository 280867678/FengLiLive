...
/* renamed from: com.slzhibo.library.ui.view.gift.GiftFrameLayout */
...
public class GiftFrameLayout extends RelativeLayout implements Handler.Callback {
    ...
    /* renamed from: com.slzhibo.library.ui.view.gift.GiftFrameLayout$BarrageEndAnimationListener */
    /* loaded from: classes6.dex */
    ...
    /* renamed from: com.slzhibo.library.ui.view.gift.GiftFrameLayout$LeftGiftAnimDismissListener */
    /* loaded from: classes6.dex */
    ...
    private void initView() {
        ...
        findViewById(R.id.fq_rl_name_bg).setOnClickListener(new View.OnClickListener() { // from class: com.slzhibo.library.ui.view.gift.-$$Lambda$GiftFrameLayout$AoK4I9gokISNOOIbEoRtawH7Dus
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.slzhibo.library.ui.view.gift.GiftFrameLayout$GiftNumAnimRunnable */
    /* loaded from: classes6.dex */
...
//    }
    ...
    private void checkGiftCountSubscribe() {
        this.runnable = new Runnable() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.1
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void startAnimation(ICustomAnim iCustomAnim) {
        ...
        if (iCustomAnim == null) {
            ObjectAnimator createFlyFromLtoR = GiftAnimationUtil.createFlyFromLtoR(this.rlBaseInfo, -getWidth(), 0.0f, 400, new OvershootInterpolator());
            createFlyFromLtoR.addListener(new AnimatorListenerAdapter() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.2
            ...
            ObjectAnimator createFlyFromLtoR2 = GiftAnimationUtil.createFlyFromLtoR(this.ivSvgaImageView, -getWidth(), 0.0f, 400, new DecelerateInterpolator());
            createFlyFromLtoR2.addListener(new AnimatorListenerAdapter() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.3
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
                    GiftFrameLayout.this.ivSvgaImageView.setVisibility(View.VISIBLE);
                }
    ...
    public void comboAnimation(boolean z) {
        ...
        if (iCustomAnim != null) {
            ...
            scaleGiftNum.addListener(new AnimatorListenerAdapter() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.4
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
                }
    ...
    public AnimatorSet endAnimation(ICustomAnim iCustomAnim) {
        ...
        createFadeAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.5
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
            }
        });
    ...
    private void startOnLineSVGAAnim(String str) {
        ...
        if (!TextUtils.isEmpty(str) && (sVGAImageView = this.ivSvgaImageView) != null && !sVGAImageView.isAnimating()) {
            try {
                ...
                this.svgaParser.decodeFromURL(new URL(GlideUtils.formatDownUrl(str)), new SVGAParser.ParseCompletion() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.6
                    @Override // com.slzhibo.library.p115ui.view.widget.svga.SVGAParser.ParseCompletion
                    public void onError() {
                    }
    ...
    private void startSVGAAnim(final String str) {
        ...
        if (!TextUtils.isEmpty(str) && (sVGAImageView = this.ivSvgaImageView) != null && !sVGAImageView.isAnimating()) {
            try {
                Observable.just(true).map(new Function<Boolean, InputStream>() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.8
                    public InputStream apply(Boolean bool) throws Exception {
                        return GiftFrameLayout.this.getSVGAFileInputStream(str);
                    }
                }).subscribeOn(Schedulers.io()).observeOn(Schedulers.io()).subscribe(new SimpleRxObserver<InputStream>() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.7
                    public void accept(InputStream inputStream) {
                        if (inputStream != null) {
                            ...
                            GiftFrameLayout.this.svgaParser.decodeFromInputStream(inputStream, str, new SVGAParser.ParseCompletion() { // from class: com.slzhibo.library.ui.view.gift.GiftFrameLayout.7.1
                                @Override // com.slzhibo.library.p115ui.view.widget.svga.SVGAParser.ParseCompletion
                                public void onError() {
                                }
    ...
    public void initGiftCount(String str) {
        this.llGiftNum.setVisibility(View.GONE);
        int childCount = this.llGiftNum.getChildCount();
        for (int i = 0; i < childCount; i++) {
            this.llGiftNum.getChildAt(i).setVisibility(View.GONE);
        }
        ...
        this.llGiftNum.setVisibility(View.VISIBLE);
    }

    public void initLuckyGiftBatchCount(String str) {
        if (!TextUtils.isEmpty(str)) {
            this.llBatchNum.setVisibility(View.GONE);
            int childCount = this.llBatchNum.getChildCount();
            for (int i = 0; i < childCount; i++) {
                this.llBatchNum.getChildAt(i).setVisibility(View.GONE);
            }
            int length = str.length();
            for (int i2 = 0; i2 < length; i2++) {
                int parseInt = Integer.parseInt(String.valueOf(str.charAt(i2)));
            ...
            this.llBatchNum.setVisibility(View.VISIBLE);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: com.slzhibo.library.ui.view.gift.GiftFrameLayout$SVGAAnimationListener */
    /* loaded from: classes6.dex */
    public class SVGAAnimationListener implements SVGACallback {
        @Override // com.slzhibo.library.p115ui.view.widget.svga.SVGACallback
        public void onPause() {
        }
