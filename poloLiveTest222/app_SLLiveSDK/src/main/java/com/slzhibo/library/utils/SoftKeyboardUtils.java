...
public class SoftKeyboardUtils {
    ...
    public static void hideDialogSoftKeyboard(Dialog dialog) {
        ...
        if (dialog != null && (currentFocus = dialog.getCurrentFocus()) != null) {
            ((InputMethodManager) dialog.getContext().getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(currentFocus.getWindowToken(), 2);
        }
    }
    ...
    private SoftKeyboardUtils(final Activity activity, ViewGroup viewGroup) {
        ...
        viewGroup.setOnTouchListener(new View.OnTouchListener() { // from class: com.slzhibo.library.utils.SoftKeyboardUtils.1
        ...
        if (viewGroup != null) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt instanceof ScrollView) {
                    ((ScrollView) childAt).setOnTouchListener(new View.OnTouchListener() { // from class: com.slzhibo.library.utils.SoftKeyboardUtils.2
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            SoftKeyboardUtils.this.dispatchTouchEvent(activity, motionEvent);
                            return false;
                    ...
                    ((AbsListView) childAt).setOnTouchListener(new View.OnTouchListener() { // from class: com.slzhibo.library.utils.SoftKeyboardUtils.3
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            SoftKeyboardUtils.this.dispatchTouchEvent(activity, motionEvent);
                            return false;
                    ...
                    ((RecyclerView) childAt).setOnTouchListener(new View.OnTouchListener() { // from class: com.slzhibo.library.utils.SoftKeyboardUtils.4
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            SoftKeyboardUtils.this.dispatchTouchEvent(activity, motionEvent);
                            return false;
                ...
                if (childAt.isClickable() && (childAt instanceof TextView) && !(childAt instanceof EditText)) {
                    childAt.setOnTouchListener(new View.OnTouchListener() { // from class: com.slzhibo.library.utils.SoftKeyboardUtils.5
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            SoftKeyboardUtils.this.dispatchTouchEvent(activity, motionEvent);
                            return false;
    ...
    private void hideSoftInput(Activity activity, IBinder iBinder) {
        if (iBinder != null) {
            ((InputMethodManager) activity.getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(iBinder, 2);
        }
    }
