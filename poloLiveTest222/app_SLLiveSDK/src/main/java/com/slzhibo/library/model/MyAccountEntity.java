...
public class MyAccountEntity implements Parcelable {
    public static final Creator<MyAccountEntity> CREATOR = new Creator<MyAccountEntity>() { // from class: com.slzhibo.library.model.MyAccountEntity.1
    ...
    public String getNobilityPrice() {
        return isFrozen() ? "0" : this.nobilityPrice;
    }
