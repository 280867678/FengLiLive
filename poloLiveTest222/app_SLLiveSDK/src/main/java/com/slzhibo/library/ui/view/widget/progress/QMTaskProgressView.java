...
public class QMTaskProgressView extends View {
    ...
    public QMTaskProgressView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mProgress = -1.0f;
        this.mAboveTextSize = (float) ConvertUtils.sp2px(8.0f);
        this.offset = ConvertUtils.dp2px(1.0f);
    ...
    private void initAttrs(Context context, AttributeSet attributeSet) {
        ...
        this.mButtonRadius = obtainStyledAttributes.getFloat(R.styleable.QMTaskProgressView_qm_radius, (float) ConvertUtils.dp2px(6.0f));
        this.mAboveTextSize = obtainStyledAttributes.getFloat(R.styleable.QMTaskProgressView_qm_text_size, (float) ConvertUtils.sp2px(8.0f));
    ...
    private void drawBackground(Canvas canvas) {
        ...
        this.mBackgroundBounds.bottom = (float) getMeasuredHeight();
        ...
        int i = this.offset;
        rectF3.set((float) i, (float) i, (float) (getMeasuredWidth() - this.offset), (float) (getMeasuredHeight() - this.offset));
        if (this.enableGradient) {
