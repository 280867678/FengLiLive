...
public class BannerCacheEntity implements Parcelable {
    public static final Creator<BannerCacheEntity> CREATOR = new Creator<BannerCacheEntity>() { // from class: com.slzhibo.library.model.cache.BannerCacheEntity.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public BannerCacheEntity createFromParcel(Parcel parcel) {
            return new BannerCacheEntity(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public BannerCacheEntity[] newArray(int i) {
