            ...
            default:
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            case 64:
                                return this.mContext.getString(R.string.fq_yx_business_income_empty_tips);
                            case 65:
                                return this.mContext.getString(R.string.fq_hj_no_video_tips);
                            case 66:
                                return this.mContext.getString(R.string.fq_hj_buy_product_empty_tips);
                            default:
                ...
                default:
                    switch (i) {
                        ...
                        default:
                            switch (i) {
                                case 64:
                                    drawable = ContextCompat.getDrawable(this.mContext, R.drawable.fq_ic_yx_income_empty);
                                    break;
                                case 65:
                                    drawable = ContextCompat.getDrawable(this.mContext, R.drawable.fq_ic_hj_default_video);
                                    break;
                                case 66:
                                    drawable = ContextCompat.getDrawable(this.mContext, R.drawable.fq_ic_hj_default_shopping);
                                    break;
                                default:
                                    drawable = ContextCompat.getDrawable(this.mContext, R.drawable.fq_ic_empty_income);
                                    break;
