...
public class WatermarkConfigEntity implements Parcelable {
    public static final Parcelable.Creator<WatermarkConfigEntity> CREATOR = new Parcelable.Creator<WatermarkConfigEntity>() { // from class: com.slzhibo.library.model.WatermarkConfigEntity.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public WatermarkConfigEntity createFromParcel(Parcel parcel) {
            return new WatermarkConfigEntity(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public WatermarkConfigEntity[] newArray(int i) {
