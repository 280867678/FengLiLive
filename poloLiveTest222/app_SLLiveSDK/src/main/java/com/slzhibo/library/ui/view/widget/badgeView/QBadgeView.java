...
import com.slzhibo.library.ui.view.widget.badgeView.Badge;
...
public class QBadgeView extends View implements Badge {
    ...
    private void showShadowImpl(boolean z) {
        float f=1.5f;
        int dp2px = (int) SystemUtils.dp2px(1.0f);
        int dp2px2 = (int) SystemUtils.dp2px(1.5f);
        int i = this.mDragQuadrant;
        if (i == 1) {
            dp2px = (int) SystemUtils.dp2px(1.0f);
            f = SystemUtils.dp2px(-1.5f);
        } else if (i == 2) {
            dp2px = (int) SystemUtils.dp2px(-1.0f);
            f = SystemUtils.dp2px(-1.5f);
        } else if (i != 3) {
            ...
            this.mBadgeBackgroundPaint.setShadowLayer(!z ? SystemUtils.dp2px(2.0f) : 0.0f, (float) dp2px, (float) dp2px2, 855638016);
        } else {
            dp2px = (int) SystemUtils.dp2px(-1.0f);
            f = SystemUtils.dp2px(1.5f);
        }
    ...
    private void drawBadgeBackground(Canvas canvas) {
        ...
        if (this.mDrawableBackgroundClip) {
            ...
            canvas.saveLayer((float) i, (float) i2, (float) i3, (float) i4, null, Canvas.ALL_SAVE_FLAG);
        }
        ...
        switch (this.mBadgeGravity) {
            ...
            case 8388661:
                if (!this.noNumber) {
                    ...
                    pointF7.x = ((float) this.mWidth) - ((f3 + f4) + (height / 2.0f));
                    pointF7.y = this.mGravityOffsetY + f4 + (this.mBadgeTextRect.height() / 2.0f);
                    break;
                } else {
                    PointF pointF8 = this.mBadgeCenter;
                    pointF8.x = ((float) this.mWidth) - (height / 2.0f);
                    pointF8.y = this.mBadgeTextRect.height() / 2.0f;
                    break;
                }
            case 8388691:
                ...
                pointF9.y = ((float) this.mHeight) - ((this.mGravityOffsetY + f6) + (this.mBadgeTextRect.height() / 2.0f));
                break;
            case 8388693:
                PointF pointF10 = this.mBadgeCenter;
                float f7 = this.mGravityOffsetX;
                float f8 = this.mBadgePadding;
                pointF10.x = ((float) this.mWidth) - ((f7 + f8) + (height / 2.0f));
                pointF10.y = ((float) this.mHeight) - ((this.mGravityOffsetY + f8) + (this.mBadgeTextRect.height() / 2.0f));
                break;
        }
        initRowBadgeCenter();
    }
    ...
    private void initRowBadgeCenter() {
        ...
        PointF pointF2 = this.mBadgeCenter;
        pointF.x = pointF2.x + ((float) iArr[0]);
        pointF.y = pointF2.y + ((float) iArr[1]);
    }
    ...
    @Override // com.slzhibo.library.ui.view.widget.badgeView.Badge
    ...
    public class BadgeContainer extends ViewGroup {
        ...
        public void onMeasure(int i, int i2) {
            ...
            view.measure(i, i2);
            if (view2 != null) {
                view2.measure(MeasureSpec.makeMeasureSpec(view.getMeasuredWidth(), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(view.getMeasuredHeight(), MeasureSpec.EXACTLY));
            }
