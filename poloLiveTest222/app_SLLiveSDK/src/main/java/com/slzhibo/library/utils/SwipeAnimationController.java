...
public class SwipeAnimationController {
    ...
    public SwipeAnimationController(Context context, ViewGroup viewGroup) {
        ...
        this.valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.slzhibo.library.utils.SwipeAnimationController.1
