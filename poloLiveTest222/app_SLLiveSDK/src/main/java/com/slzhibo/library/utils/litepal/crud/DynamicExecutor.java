...
public class DynamicExecutor {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Object send(Object obj, String str, Object[] objArr, Class<?> cls, Class<?>[] clsArr) throws SecurityException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        if (objArr == null) {
            objArr = new Object[0];
        }
        if (clsArr == null) {
