...
//import com.slzhibo.library.analytics.Pathfinder;
//import com.slzhibo.library.analytics.ScreenAutoTracker;
import com.slzhibo.library.analytics.Pathfinder;
import com.slzhibo.library.analytics.SensorsDataAPI;
//import com.slzhibo.library.analytics.SensorsDataFragmentTitle;
...
public class AopUtil {
    private static ArrayList<String> sOSViewPackage = new ArrayList<String>() { // from class: com.slzhibo.library.analytics.util.AopUtil.1
        {
            add("android##widget");
    ...
    public static Activity getActivityFromContext(Context context, View view) {
        ...
        try {
            if (context instanceof Activity) {
                ...
                activity = (Activity) context;
            } else if (view == null  || !(tag instanceof Activity)) {
                return null;
            } else {
...
//            }
    ...
    public static String getViewId(View view) {
        String str = null;
        try {
//            String str2 = (String) view.getTag(C6134R.C6139id.common_analytics_tag_view_id);
            try {
...
//            return "1".equals(view.getTag(R.id.common_analytics_tag_view_ignored));
        } catch (Exception unused) {
            return true;
        }
        return true;
...
//                JSONObject jSONObject2 = (JSONObject) view.getTag(C6134R.C6139id.common_analytics_tag_view_properties);
//                if (jSONObject2 == null) {
//                    return true;
//                }
//                mergeJSONObject(jSONObject2, jSONObject);
    ...
    public static Object getFragmentFromView(View view) {
        ...
        try {
//            r2 = (String) view.getTag(C6134R.C6139id.common_analytics_tag_view_fragment_name);
//            String str = (String) view.getTag(C6134R.C6139id.common_analytics_tag_view_fragment_name2);
//            if (!TextUtils.isEmpty(str)) {
//            }
//            if (!TextUtils.isEmpty(str)) {
