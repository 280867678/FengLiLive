...
import com.example.websocket.com.neovisionaries.ws.client.StateManager;
...
public class ReadingThread extends WebSocketThread {
    ...
    */
    private WebSocketFrame readFrame() {
        ...
        try {
            ...
            try {
                ...
                if (z) {
                    callOnError(e);
                    callOnFrameError(e, webSocketFrame);
                }
    ...
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError = new int[WebSocketError.values().length];

        static {
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.INSUFFICENT_DATA.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.INVALID_PAYLOAD_LENGTH.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.NO_MORE_FRAME.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.TOO_LONG_PAYLOAD.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.INSUFFICIENT_MEMORY_FOR_PAYLOAD.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.NON_ZERO_RESERVED_BITS.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.UNEXPECTED_RESERVED_BIT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.UNKNOWN_OPCODE.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.FRAME_MASKED.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.FRAGMENTED_CONTROL_FRAME.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.UNEXPECTED_CONTINUATION_FRAME.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.CONTINUATION_NOT_CLOSED.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.TOO_LONG_CONTROL_FRAME_PAYLOAD.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.INTERRUPTED_IN_READING.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[WebSocketError.IO_ERROR_IN_READING.ordinal()] = 15;
    ...
    private WebSocketFrame createCloseFrame(WebSocketException webSocketException) {
        int i = 1002;
        switch (AnonymousClass1.$SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketError[webSocketException.getError().ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 6:
    ...
    public class CloseTask extends TimerTask {
        private CloseTask() {
//            ReadingThread.this = r1;
        }

        /* synthetic */ CloseTask(ReadingThread readingThread, AnonymousClass1 r2) {
            this();
        }
