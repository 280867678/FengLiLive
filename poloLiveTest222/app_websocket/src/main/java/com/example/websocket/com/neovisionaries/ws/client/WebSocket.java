...
public class WebSocket {
    ...
    public WebSocket disconnect(int i, String str, long j) {
        synchronized (this.mStateManager) {
            int i2 = AnonymousClass1.$SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketState[this.mStateManager.getState().ordinal()];
            if (i2 == 1) {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketState = new int[WebSocketState.values().length];

        static {
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketState[WebSocketState.CREATED.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$example$websocket$com$neovisionaries$ws$client$WebSocketState[WebSocketState.OPEN.ordinal()] = 2;
