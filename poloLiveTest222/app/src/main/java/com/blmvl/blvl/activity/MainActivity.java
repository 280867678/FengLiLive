...
//        b.m5045w();
    ...
    public final void m21042G() {
        this.f596c.add(CustomWordUtil.m9463a(R.string.str_home));
        this.f596c.add(CustomWordUtil.m9463a(R.string.featured));
        if (SpUtil.m9573D().m9515y()) {
            this.f596c.add(CustomWordUtil.m9463a(R.string.live));
        }
        if (SpUtil.m9573D().m9574C() == 1) {
            this.f596c.add(CustomWordUtil.m9463a(R.string.str_game));
        }
        this.f596c.add(CustomWordUtil.m9463a(R.string.mine));
        ...
        this.f597d.add(Integer.valueOf(R.drawable.ic_video_seletor));
        this.f597d.add(Integer.valueOf(R.drawable.ic_featured_seletor));
        if (SpUtil.m9573D().m9515y()) {
            this.f597d.add(Integer.valueOf(R.drawable.ic_live_seletor));
        }
        if (SpUtil.m9573D().m9574C() == 1) {
            this.f597d.add(Integer.valueOf(R.drawable.ic_game_seletor));
        }
        this.f597d.add(Integer.valueOf(R.drawable.ic_mine_seletor));
    ...
    public void m21041N() {
        if (System.currentTimeMillis() - this.f595b > 2000) {
            ToastUtil.m9102c(this, CustomWordUtil.m9463a(R.string.exit_app_hint));
    ...
    public final void m21039R() {
        this.f599f = findViewById(R.id.img_game);
        this.f600g = findViewById(R.id.img_close);
        ...
        this.f601h = findViewById(R.id.layout_game);
        ...
        if (SpUtil.m9573D().m9574C() == 1) {
            if (!(AppConfig.getInstance().getConfig() == null || AppConfig.getInstance().getConfig().getGame_float() == null || TextUtils.isEmpty(AppConfig.getInstance().getConfig().getGame_float().getIcon()))) {
                ...
                ImgLoader.m9424b(AppConfig.getInstance().getConfig().getGame_float().getIcon(), this.f599f, R.drawable.bg_square_default);
            }
    ...
    public class C0639a extends ComViewPagerHelper {
        ...
        public IPagerTitleView mo9153a(Context context, final int i, ViewPager viewPager, List<String> list, List<Integer> list2) {
            ...
            View inflate = LayoutInflater.from(context).inflate(R.layout.view_main_bottom_tab, null);
            TextView textView = inflate.findViewById(R.id.tv_tab);
            ImageView imageView = inflate.findViewById(R.id.img_tab);
            ImageView imageView2 = inflate.findViewById(R.id.img_badge);
            textView.setText(MainActivity.this.f596c.get(i));
            if (MainActivity.this.f596c.get(i).equals(CustomWordUtil.m9463a(R.string.str_game))) {
