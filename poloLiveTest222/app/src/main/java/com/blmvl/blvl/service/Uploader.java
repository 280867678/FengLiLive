...
public class Uploader {
    ...
    public class C4229d extends Thread {
        ...
        public final void m9584f() {
            ...
            ((PostRequest) ((PostRequest) OkGo.post(videoUploadUrl).params(m9593a(localVideoUrl))).tag(String.format("%s%s", "upload_video", Uploader.this.f12988c.getTaskId()))).isMultipart(true).execute(new C4231b());
        }
        ...
        public HttpParams m9593a(String str) {
            ...
            httpParams.put("uuid", AppUser.getInstance().getUser().getUid());
        ...
        public final void m9592b() {
            ...
            ((PostRequest) OkGo.post(b).params(UploadImgUtil.m9504b(new File(Uploader.this.f12988c.getLocalCoverUrl())))).tag(String.format("%s%s", "upload_video_cover", Uploader.this.f12988c.getTaskId())).execute(new C4230a());
        }
    ...
    /* renamed from: j */
    public void m9600j() {
        OkGo.getInstance().cancelTag(String.format("%s%s", "upload_video_cover", this.f12988c.getTaskId()));
        OkGo.getInstance().cancelTag(String.format("%s%s", "upload_video", this.f12988c.getTaskId()));
